...
mysql_cep_db_service_port=10091
...
function deploy_distributed() {
  ...
  deploy_wso2_service 'mysql-cep-db' $mysql_cep_db_service_port
  deploy_wso2_service 'wso2cep-presenter' $wso2cep_presenter_service_port
  echoBold "wso2cep-presenter management console: https://${marathon_lb_host_ip}:${wso2cep_presenter_service_port}/carbon"
  deploy_wso2_service 'wso2cep-worker' $wso2cep_worker_service_port
...
function deploy_default() {
  ...
  deploy_common_services
  deploy_wso2_service 'mysql-cep-db' $mysql_cep_db_service_port
  deploy_wso2_service 'wso2cep-default' $wso2cep_default_service_port
  echoBold "wso2cep-default management console: https://${marathon_lb_host_ip}:${wso2cep_default_service_port}/carbon"
