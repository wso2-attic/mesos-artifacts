...
function deploy_distributed() {
  ...
  deploy_service 'mysql-esb-db' $mysql_esb_db_host_port
  deploy_service 'wso2esb-manager' $wso2esb_manager_service_port
  echoBold "wso2esb-manager management console: https://${marathonlb_host_ip}:${wso2esb_manager_service_port}/carbon"
...
function deploy_default() {
  ...
  echoBold "wso2esb-default management console: https://${marathonlb_host_ip}:${wso2esb_default_service_port}/carbon"
