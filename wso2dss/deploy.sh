...
function deploy_distributed() {
  ...
  deploy_service 'mysql-dss-db' $mysql_dss_db_host_port
  deploy_service 'wso2dss-manager' $wso2dss_manager_service_port
  echoBold "wso2dss-manager management console: https://${marathonlb_host_ip}:${wso2dss_manager_service_port}/carbon"
...
function deploy_default() {
  ...
  echoBold "wso2dss-default management console: https://${marathonlb_host_ip}:${wso2dss_default_service_port}/carbon"
